#
#  Be sure to run `pod spec lint TOBrowserActivityKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of TOBrowserActivityKit in Markdown format.
  ...
  s.source       = { :git => "https://github.com/TimOliver/TOBrowserActivityKit.git", :tag => "1.0.0" }
